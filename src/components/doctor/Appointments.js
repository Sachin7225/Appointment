        ...
        try {
            ...
            if (response.data.status) {
                ...
                if (indexToUpdate !== -1) {
                    ...
                    updatedList.splice(indexToUpdate, 12, { ...patientList[indexToUpdate], activeStatus: response.data.activeStatus });
        ...
        <section id="appointment" className="appointment section-bg " style={{ marginTop: "80px" }}>
            <div className="container">
                ...
                <div className="section-title">
                 ...
                 <div className="section-title"><div class="spinner-border " role="status">
